...
var con = mysql.createConnection({
  ...
  con.connect(function(err) {
    ...
    var q1 = "CREATE TABLE Student(Roll_No varchar(13), First_name varchar(15), Middle_name varchar(15),Last_name varchar(15), Age int(3), Sex varchar(2), Department varchar(40), Designation_in_club varchar(20), SIG varchar(15),PRIMARY KEY(Roll_no))";

    var q2 = "CREATE TABLE Clubs(Name varchar(20), SIG_Head varchar(20), No_of_Members int(4), Convenor varchar(20), PRIMARY KEY(Name))";

    var q3 = "CREATE TABLE Projects(Project_ID varchar(10), Discipline varchar(15), Start_time varchar(25), End_time varchar(25), Name varchar(25), Supervising_club varchar(20), No_students int(2), PRIMARY KEY(Project_ID))";
